...
## Project Structure
    ...
    ├── testapiautosetting_124853  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124853`
...
2. Clone this repo and `cd testapiautosetting_124853`
